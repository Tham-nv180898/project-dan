...
export const PANELS_DATA: Panel[] = [
  {
    id: "MA-01",
    slug: "ma-01",
    ...
    description: "Kính thưa các đồng chí! Phòng Hồ Chí Minh Tiểu đoàn là một trong những thiết chế văn hóa quan trọng được trang bị cho đơn vị đặt dưới sự quản lý của người chỉ huy sự lãnh đạo của cấp ủy...",
    content: `Kính thưa các đồng chí! 
Phòng Hồ Chí Minh Tiểu đoàn là một trong những thiết chế văn hóa quan trọng được trang bị cho đơn vị đặt dưới sự quản lý của người chỉ huy sự lãnh đạo của cấp ủy và sự hướng dẫn nghiệp vụ của cơ quan Tuyên Huấn cấp trên đây. Đây là nơi giáo dục lịch sử, truyền thống, đồng thời là điểm hẹn văn hóa, giải trí trong giờ nghỉ, ngày nghỉ của bộ đội.
...
Theo hướng dẫn của TCCT phòng Hồ Chí Minh được thống nhất bố trí, sắp xếp theo 4 mặt: A, B, C, D (kết hợp chỉ)
...
Mặt C của phòng Hồ Chí Minh được bố trí:
- Hướng từ trên nhìn xuống, bên tay trái ngoài cùng được bố trí mảng ảnh “Tuổi trẻ Quân đội phát huy truyền thống, cống hiến tài năng, xứng danh Bộ đội Cụ Hồ thời kỳ mới”.
- Tiếp theo ở chính giữa được bố trí tủ sách của đơn vị chia thành 5 mảng chính với hơn 1000 đầu sách và nhiều thể loại sách khác nhau.
- Phía trên, chính giữa là khu bằng khen, giấy khen của đơn vị, trưng bày cờ thưởng các loại.
Tiếp theo được bố trí mảng ảnh “Đơn vị chúng tôi”.

Mặt D của phòng Hồ Chí Minh được bố trí:
- Mảng ảnh số thứ nhất, “Đảng Cộng sản Việt Nam, người tổ chức và lãnh đạo mọi thắng lợi của cách mạng Việt Nam ”.
- Tiếp theo bên cạnh là mảng ảnh “Việt Nam, đất nước, con người”
- Tiếp theo phía dưới là mảng ảnh “Chủ tịch Hồ Chí Minh - Cuộc đời và sự nghiệp”.
- Phía dưới được bố trí mảng ảnh “Quân đội ta trung với Đảng, hiếu với dân, sẵn sàng chiến đấu hy sinh vì độc lập tự do của Tổ quốc, vì chủ nghĩa xã hội. Nhiệm vụ nào cũng hoàn thành, khó khăn nào cũng vượt qua, kẻ thù nào cũng đánh thắng”.
- Tiếp theo là khu bố trí giá báo của đơn vị, hiện tại đơn vị thực hiện lưu trữ và hoạt động đủ 16 loại báo, tạp chí đa dạng về thể loại đã đáp ứng được nhu cầu cho cán bộ, chiến sĩ trong đơn vị nghiên cứu học tập nâng cao trình độ mọi mặt. 
- Phía cuối là bố trí Tủ sách pháp luật
- Chính giữa Phòng Hồ Chí Minh là hệ thống bàn, ghế, vị trí trưng bày các loại sách, báo, tạp chí và là nơi để cán bộ, chiến sĩ nghiên cứu, học tập sau những giờ nghỉ, ngày nghỉ.

Sau đây kính mời các đồng chí tham quan các mảng ảnh được bố trí tại phòng Hồ Chí Minh.

MẢNG ẢNH THỨ I: MẢNG ẢNH “ĐẢNG CỘNG SẢN VIỆT NAM, NGƯỜI TỔ CHỨC VÀ LÃNH ĐẠO MỌI THẮNG LỢI CỦA CÁCH MẠNG VIỆT NAM”
...
Thưa toàn thể các đồng chí! 
Tình hình thế giới cuối thế kỷ XIX, đầu thế kỷ XX chủ nghĩa tư bản chuyển từ giai đoạn tự do cạnh tranh sang giai đoạn độc quyền. Các đế quốc đua nhau xâm lược vơ vét tài nguyên các nước thuộc địa.
Ở nước Nga, Năm 1917, Cách mạng tháng Mười Nga thắng lợi, chủ nghĩa Mác – Lênin từ lý luận đã trở thành hiện thực. Đây là nguồn cổ vũ to lớn cho các dân tộc bị áp bức đứng lên đấu tranh giải phóng dân tộc, giải phóng giai cấp, giải phóng con người.
Năm 1919, Quốc tế Cộng sản (Quốc tế III) ra đời thúc đẩy sự phát triển mạnh mẽ phong trào cộng sản và công nhân quốc tế.

Trong nước, năm 1858 thực dân Pháp xâm lược nước ta và thi hành chính sách cai trị hà khắc. Sự thống trị tàn bạo của thực dân Pháp đã làm cho mâu thuẫn dân tộc diễn ra hết sức gay gắt, hàng loạt phong trào yêu nước theo các khuynh hướng khác nhau liên tiếp nổ ra. Tiêu biểu là phong trào Cần Vương, phong trào Đông Du, khởi nghĩa Yên Thế... Các cuộc đấu tranh giải phóng dân tộc tuy diễn ra quyết liệt, song cuối cùng đều bị thất bại vì thiếu một đường lối, phương pháp đấu tranh đúng đắn.

Trước tình hình đó, ngày 5/6/1911, người thanh niên yêu nước Nguyễn Tất Thành đã ra đi tìm đường cứu nước giải phóng dân tộc. Năm 1920 Nguyễn Ái Quốc đã đến với chủ nghĩa Mác – Lênin thông qua bản luận cương về vấn đề dân tộc và thuộc địa. Từ đây, Nguyễn Ái Quốc ra sức chuẩn bị mọi mặt cho việc thành lập một chính đảng vô sản ở Việt Nam, thông qua truyền bá hệ thống chủ nghĩa Mác - Lênin vào trong nước.

Từ tháng 6/1929 đến tháng 01/1930 ở Việt Nam lần lượt xuất hiện 3 tổ chức cộng sản là Đông Dương Cộng sản Đảng, An Nam Cộng sản Đảng, Đông Dương Cộng sản Liên đoàn.
Chỉ trong một thời gian ngắn ở Việt Nam đã có ba tổ chức cộng sản được thành lập. Điều đó phản ánh xu thế tất yếu của phong trào đấu tranh cách mạng. Song sự tồn tại của ba tổ chức cộng sản dẫn đến nguy cơ chia rẽ lớn. Yêu cầu bức thiết của cách mạng là cần có một Đảng thống nhất lãnh đạo. 

Từ ngày 06/01 đến 7-2-1930, Hội nghị hợp nhất ba tổ chức Cộng sản họp tại Cửu Long (Hương Cảng, Trung Quốc) dưới sự chủ trì của đồng chí Nguyễn Ái Quốc. Hội nghị nhất trí thành lập đảng thống nhất, lấy tên là Đảng Cộng sản Việt Nam, thông qua Chánh cương vắn tắt, Sách lược vắn tắt, Chương trình tóm tắt và Điều lệ vắn tắt của Đảng. (Chỉ ảnh Hội nghị thành lập ĐCSVN)

Sau này, tại Đại hội đại biểu toàn quốc lần thứ III của Đảng (9/1960) quyết định lấy ngày 03 tháng 02 dương lịch hằng năm làm ngày kỷ niệm thành lập Đảng Cộng sản Việt Nam. 
Sự ra đời của Đảng Cộng sản Việt Nam đánh dấu bước ngoặt lịch sử của cách mạng Việt Nam, chấm dứt sự khủng hoảng đường lối lãnh đạo; là kết quả tất yếu của cuộc đấu tranh dân tộc và giai cấp ở nước ta trong thời đại mới, là sản phẩm của sự kết hợp giữa chủ nghĩa Mác – Lê nin với phong trao công nhân và phong trào yêu nước Việt Nam.

Thưa toàn thể các đồng chí!
Ngay sau khi ra đời, Đảng ta đã quy tụ các tầng lớp nhân dân đứng lên đấu tranh, tạo nên một phong trào cách mạng rộng lớn trong những năm 1930-1931 mà đỉnh cao là phong trào Xô viết Nghệ - Tĩnh.
Mặc dù bị đàn áp khốc liệt, song cao trào Xô viết Nghệ Tĩnh có ý nghĩa lịch sử to lớn, khẳng định quyền lãnh đạo tuyệt đối của Đảng đối với cách mạng Việt Nam; xây dựng được khối liên minh giai cấp công nhân và giai cấp nông dân; góp phần giáo dục tư tưởng, giác ngộ cách mạng, rèn luyện tinh thần đấu tranh cho đảng viên và quần chúng, chuẩn bị lực lượng cho giai đoạn tiếp sau; để lại những kinh nghiệm lãnh đạo quý báu. (Chỉ ảnh Cao trào Xô Viết – Nghệ Tĩnh 1930 – 1931).

Từ năm 1936 – 1939, Đảng ta đề ra chủ trương đấu tranh đòi dân sinh, dân chủ. Phong trào đã giác ngộ hàng triệu quần chúng thuộc các giai cấp, tầng lớp khác nhau; tạo ra thế và lực mới cho phong trào cách mạng tiếp theo.

Ngày 28-1-1941, Nguyễn Ái Quốc về nước trực tiếp lãnh đạo cách mạng Việt Nam. Hội nghị Ban Chấp hành Trung ương Đảng lần thứ 8 (tháng 5/1941) là một mốc lịch sử đặc biệt quan trọng, hoàn chỉnh bước chuyển hướng chỉ đạo chiến lược, xác định phương pháp cách mạng là đi từ khởi nghĩa từng phần tiến lên tổng khởi nghĩa giành chính quyền trong cả nước.

Vào ngày 9-3-1945, Nhật tiến hành làm đảo chính Pháp để độc chiếm Đông Dương; ngày 12-3-1945, Đảng ra bản Chỉ thị lịch sử “Nhật-Pháp bắn nhau và hành động của chúng ta”, phát động một cao trào kháng Nhật, cứu nước mạnh mẽ.

Nhìn lại chặng đường vẻ vang hơn 96 năm qua, chúng ta càng thêm thấm nhuần một chân lý: Đảng Cộng sản Việt Nam không chỉ là người tổ chức, lãnh đạo mọi thắng lợi của cách mạng, mà còn là hiện thân cho ý chí, khát vọng độc lập và sự phồn vinh của dân tộc ta.

Thế nhưng, thưa các đồng chí, công cuộc bảo vệ thành quả cách mạng ấy chưa bao giờ là dễ dàng! Trong giai đoạn hiện nay, các thế lực thù địch vẫn đang ráo riết sử dụng chiêu bài "diễn biến hòa bình", lợi dụng các phương tiện thông tin đại chúng và không gian mạng để gieo rắc những thông tin độc hại, hòng phủ nhận vai trò lãnh đạo của Đảng và làm lung lay khối đại đoàn kết toàn dân tộc.

Đứng trước những thách thức đó, mỗi quân nhân cách mạng chúng ta tuyệt đối không được lơ là, mất cảnh giác. Bản lĩnh chính trị vững vàng, lập trường kiên định chính là "tấm khiên" vững chắc nhất để chúng ta tự bảo vệ mình và bảo vệ Đảng. Mỗi đồng chí không chỉ là một chiến sĩ vững vàng tay súng, mà còn phải là một chiến sĩ kiên trung trên mặt trận tư tưởng; chủ động nhận diện, kiên quyết đấu tranh phản bác các quan điểm sai trái, đồng thời làm tốt công tác dân vận để nhân dân luôn tin tưởng tuyệt đối vào sự lãnh đạo của Đảng.

Thưa các đồng chí! Đứng trước mảng ảnh này, hầu hết chúng ta đều là những đoàn viên, thanh niên ưu tú, là sức trẻ và tương lai của quân đội. Chúng ta hãy biến niềm tự hào về Đảng thành hành động thiết thực trong từng nhiệm vụ huấn luyện, sẵn sàng chiến đấu, trong học tập và công tác. Hãy ra sức rèn đức, luyện tài, không ngừng phấn đấu để vinh dự được đứng vào hàng ngũ của Đảng Cộng sản Việt Nam, tiếp bước cha anh, đem trọn trí tuệ và nhiệt huyết cống hiến cho sự nghiệp xây dựng và bảo vệ Tổ quốc Việt Nam xã hội chủ nghĩa.

Sau đây, mời các đồng chí di chuyển tham quan Mảng ảnh số 2: “Việt Nam – Đất nước, con người”.`,
    imageSrc: "/images/panels/panel-01.jpg",
    audioSrc: "/audio/audio1.mp3",
    audioDuration: "04:10",
    badge: "Âm thanh",
    roomLabel: "PHÒNG HỒ CHÍ MINH"
  },
  {
    id: "MA-02",
    slug: "ma-02",
...
export function getPanelBySlug(slug: string): Panel | undefined {
  return PANELS_DATA.find((p) => p.slug === slug || p.id.toLowerCase() === slug.toLowerCase());
}

export function getAdjacentPanels(currentSlug: string): { prev?: Panel; next?: Panel } {
  const currentIndex = PANELS_DATA.findIndex(
    (p) => p.slug === currentSlug || p.id.toLowerCase() === currentSlug.toLowerCase()
  );
  if (currentIndex === -1) return {};

  return {
    prev: currentIndex > 0 ? PANELS_DATA[currentIndex - 1] : undefined,
    next: currentIndex < PANELS_DATA.length - 1 ? PANELS_DATA[currentIndex + 1] : undefined
  };
}
